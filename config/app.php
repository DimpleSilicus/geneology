 ...
 * @version    GIT: $Id: 53532e1ef4c013733b8c168d5b0d15d4219f2d53 $
 * @link       None
 * @filesource
 */
return [
    ...
    'providers' => [
        ...
        Modules\MyApps\MyAppsServiceProvider::class,
        Modules\Pages\PagesServiceProvider::class,
        Modules\Profile\ProfileServiceProvider::class,
        Modules\User\UserServiceProvider::class,
        Modules\ToolKit\ToolKitServiceProvider::class,
        Modules\Gedcom\GedcomServiceProvider::class,
		Modules\Maps\MapsServiceProvider::class
    ],
    /*
      |--------------------------------------------------------------------------
      | Class Aliases
    ...
    'aliases' => [
        ...
        'Seo' => Modules\ToolKit\Facades\Seo::class
