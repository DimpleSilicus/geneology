            ...
            <div class="box box-solid">
                ...
                <div class="box-body no-padding ">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="cur  {{$folderName == 'drafts' ? 'active' : '' }}">
        ...
        <div class="col-md-9">
            ...
            <div class="box-body no-padding">
                ...
                <div style="min-height: 360px;" class="table-responsive mailbox-messages">
                    ...
                    <br/>
                    <button class="btn btn-primary" id="submit" onclick="sendMessage({{$messageDetails->id}})"><i class="fa fa-envelope-o"></i>Send</button>
                    <!-- /.table -->
                </div>
                <!-- /.mail-box-messages -->
            </div>
