            ...
            <div class="box-body no-padding">
                <div class="mailbox-controls">
                    ...
                    <div class="btn-group">
                        ...
                        <button title="Move to Trash" id="{{$messageDetails->id}}"  foldername="{{$folderName}}" class="btn btn-default btn-sm btn-trashed">
                            <i class="fa fa-trash-o">
                            </i>
                        </button>
                        <button title="Reply" id="{{$messageDetails->id}}" foldername="{{$folderName}}" class="btn btn-default btn-sm btn-reply">
                            <i class="fa fa-reply">
                            </i>
                        </button>
                        <button id="{{$messageDetails->id}}" title="Forward" foldername="{{$folderName}}" class="btn btn-default btn-sm btn-forward">
                            <i class="fa fa-share">
                            </i>
                        </button>
            ...
            <div id="show-message" class="box-footer no-padding">
                <div class="mailbox-controls">
                    <div class="btn-group">
                        ...
                        <button title="Forward" id="{{$messageDetails->id}}" foldername="{{$folderName}}" class="btn btn-default btn-sm btn-forward">
