                    ...
                    <div class="box-body no-padding">
                        <div class="mailbox-controls">
                            ...
                            <div class="btn-group">
                                ...
                                <button title="Delete" class="btn btn-default btn-sm btn-trashed" onclick="delTrash()">
                                    <i class="fa fa-trash-o">
                                    </i>
                                </button>
                        ...
                        <div style="min-height: 360px;" class="table-responsive mailbox-messages">
                            <table class="table table-hover table-striped">
                                <tbody id="search-results">
                                    ...
                                    <tr style="background-color: #fff" data-status="" class="check-read" id="{{$message->id}}">
                                        <td>
                                            <input type="checkbox" id="{{$message->id}}" class="checkbox" name="listMessageID">
                                        </td>
                                        <td class="mailbox-subject single" onclick="openMessageTrash({{$message->id}})">
                                            <b>
                                                {{$message->subject}}
                                            </b>
                                        </td>
                                        <td class="mailbox-date single" onclick="openMessageTrash({{$message->id}})">
