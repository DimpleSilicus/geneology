            ...
            <div id="entry-message"><div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right">
                            <form id="search" action="{{url($url.'/messages/sent')}}" method="post">
                    ...
                    <div class="box-body no-padding">
                        <div class="mailbox-controls">
                            ...
                            <div class="btn-group">
                                ...
                                <button title="Move to Trash" class="btn btn-default btn-sm btn-trashed" onclick="delSent()">
                                    <i class="fa fa-trash-o">
                                    </i>
                                </button>
                            ...
                            <table class="table table-hover table-striped">
                                <tbody id="search-results">
                                    ...
                                    <tr style="background-color: #fff" data-status="" class="check-read" id="{{$draftMessage->id}}">
                                        ...
                                        <td class="mailbox-subject single" onclick="openMessageSent({{$draftMessage->id}})">
                                            <b>
                                                {{$draftMessage->subject}}
                                            </b>
                                        </td>
                                        <td class ="mailbox-date single" onclick="openMessageSent({{$draftMessage->id}})">
