...
/**
 * MessageAdminController class for administrator
 *
 * @name     MessageAdminController
 * @category Controller
 * @package  MessageSystem
...
class MessageAdminController extends AdminBaseController
{
    ...
    public function __construct()
    {
        ...
        $cssFiles[] = $this->url . '/theme/' . $this->adminTheme . '/assets/MessageSystem/css/admin.css';
        $jsFiles[]  = "https://cdnjs.cloudflare.com/ajax/libs/bootstrap3-dialog/1.34.7/js/bootstrap-dialog.min.js";
        $jsFiles[]  = $this->url . '/theme/' . $this->adminTheme . '/assets/MessageSystem/js/admin.js';
    ...
    public function createMessage(Request $request)
    {
        ...
        if ($request->method() == 'POST') {
            ...
            if ($messageId) {
                ...
                return redirect('/admin/messages/inbox')->with('successMessage', 'Message sent successfully.');
            } else {
                return redirect('/admin/messages/create')->with('errorMessage', 'Please try again.');
            }
        }
    ...
    /**
     * Insert message as draft message into database
     *
     * @name   draftMessage
     * @access public
     * @author Vivek Bansal <vivek.bansal@silicus.com>
    ...
    /**
     * Insert message into database as sent message
     *
     * @name   sentMessage
     * @access public
     * @author Vivek Bansal <vivek.bansal@silicus.com>
    ...
    /**
     * Showing message as inbox from database
     *
     * @name   inboxMessage
     * @access public
     * @author Vivek Bansal <vivek.bansal@silicus.com>
    ...
    /**
     * Make message status as deleted (For permanent delete)
     *
     * @name   deleteMessage
     * @access public
     * @author Vivek Bansal <vivek.bansal@silicus.com>
    ...
    public function deleteMessage($arrayIds)
    {
        ...
        return redirect('/admin/messages/trash')->with('successMessage', 'Message deleted successfully.');
    }

    /**
     * Delete drafted message permanently (hard delete)
     *
    ...
    public function deleteDraftMessage($arrayIds)
    {
        ...
        return redirect('/admin/messages/drafts')->with('successMessage', 'Message deleted successfully.');
    }
    ...
    public function moveToTrashMessageFromInbox($arrayIds)
    {
        ...
        return redirect('/admin/messages/inbox')->with('successMessage', 'Message deleted successfully.');
    }
    ...
    public function moveToTrashMessageFromSent($arrayIds)
    {
        ...
        return redirect('/admin/messages/sent')->with('successMessage', 'Message deleted successfully.');
    }
    ...
    public function sentDraftMessage($messageId)
    {
        ...
        return redirect('/admin/messages/drafts')->with('successMessage', 'Message sent successfully.');
    }
    ...
    public function restoreMessage($messageId)
    {
        ...
        return redirect('/admin/messages/trash')->with('successMessage', 'Message restore successfully.');
    }
