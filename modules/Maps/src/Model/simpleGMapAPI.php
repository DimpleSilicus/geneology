...
use App\simpleGMapGeocoder;

class simpleGMapAPI extends Model
{
    use Notifiable;
	...
	*/
	function printGMapsJS()
	{
		...
		echo "\n<script src=\"http://maps.google.com/maps/api/js?key=AIzaSyCU2e_In4Hd5tgOnifEXyn4q-3gPspHO8M&sensor=$_sensor\" type=\"text/javascript\"></script>\n";
		// swapnil api key
	}
	
	function printGMapsJS1()
	{
		$this->apiSensor ? $_sensor = "true" : $_sensor = "false";
		
		echo "\n<!-- Include Google Maps JS -->";
		echo "\n<script src=\"http://maps.google.com/maps/api/js?key=AIzaSyA4ZQeiB2DqH6WsqlXSnyZiJgEZTsgo9F0&sensor=$_sensor\" type=\"text/javascript\"></script>\n";
		// swapnil api key
	}
	/**
	...
	*/
	...
	{
		$geoCoder = new simpleGMapGeocoder(); //  object of class simpleGMapGeocoder
		$result = array();
