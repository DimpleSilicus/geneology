...
class UserController extends Controller
{
    ...
    public function showProfileForm()
    {
        ...
        $userDetails = User::getInfo(Auth()->id());
    ...
    {
        if ($request->name == 'username' || $request->name == 'name' || $request->name == 'email') {
            User::saveProfile($request->name, $request->value, auth()->id());
        } else {
            Profile::saveProfile($request->name, $request->value, auth()->id());
        }
        return;
    }
