...
<html lang="en">
    <head>
        ...
        <!--file uploader-->
        <link href="{{ url('/theme') }}/{{$theme}}/css/file-upload/fileinput.css" media="all" rel="stylesheet" type="text/css" />
         <!--date picker-->
        ...
        <script src="http://maps.google.com/maps-api-v3/api/js/30/2/common.js" ></script>
        <script src="http://maps.google.com/maps-api-v3/api/js/30/2/map.js" ></script>
        <script src="http://maps.google.com/maps-api-v3/api/js/30/2/util.js" ></script>
        <script src="http://maps.google.com/maps-api-v3/api/js/30/2/marker.js" ></script>
        <script src="http://maps.google.com/maps-api-v3/api/js/30/2/infowindow.js" ></script>
        <script src="http://maps.google.com/maps-api-v3/api/js/30/2/onion.js" ></script>
        <script src="http://maps.google.com/maps-api-v3/api/js/30/2/stats.js" ></script>
        <script src="http://maps.google.com/maps-api-v3/api/js/30/2/controls.js" ></script>
        
        <!--  Google API key :  AIzaSyA_A9fs9FrYYp3indJT3OzEg7jMK3xt-fk   -->
